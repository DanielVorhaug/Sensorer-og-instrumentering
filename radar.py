...
test_time = np.array([[4.48, 5.42, 4.44, 4.07, 5.54, 5.89],
                      [3.33, 3.38, 3.42, 3.32, 100.0, 100.0],
                      [2.18, 2.14, 2.00, 1.98, 100.0, 100.0],
                      [-2.49, -2.57, -2.61, -2.57, 100.0, 100.0],
                      [-1.74, -1.70, -1.78, -1.85, 100.0, 100.0],
                      [-1.06, -0.99, -1.20, -1.26, 100.0, 100.0]])
test_velocity = np.true_divide(test_distance, test_time)
